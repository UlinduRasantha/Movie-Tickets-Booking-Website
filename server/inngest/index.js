...
// Inngest Function to cancle booking and release seats of show after 10 minutes of booking created if payment is not made
                    ...
                    body: `<div style="font-family: Arial, sans-serif; padding: 20px;">
                            ...
                            <p>
                                is scheduled for <strong>${new Date(task.showTime).
                                    toLocaleDateString('en-US', { timeZone: 'Asia/Colombo' })}</strong>
                                at
                                <strong>${new Date(task.showTime).toLocaleTimeString
                                    ('en-US', { timeZone: 'Asia/Colombo' })}</strong>.
                            </p>
