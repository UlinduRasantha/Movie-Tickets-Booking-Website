...
const HeroSection = () => {
  ...
  return (
    ...
    lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <img src={assets.hw} alt="" className='max-h-30 lg:h-30 mt-30 mb-5' />

        {/* <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold
        max-w-110'>How to Train<br/>Your Dragon </h1> */}

        <div className='flex items-center gap-4 text-gray-300'>
            <span>Fantas | Adventure </span>
        ...
        <p className='max-w-md text-gray-300'> As an ancient threat endangers both Vikings and dragons alike on the isle of Berk,
             the friendship between Hiccup, an inventive Viking, and Toothless, a Night Fury dragon,
              becomes the key to both species forging a new future together.</p>
